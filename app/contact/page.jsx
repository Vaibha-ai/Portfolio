...
const info=[
    {
        icon: <FaPhoneAlt />,
        title: "Phone",
        description: "(+91) 80898 23085",
    },
    {
        icon: <FaEnvelope />,
        title: "Email",
        description: "vaibhav.vengad@gmail.com",
    },
    {
        icon: <FaMapMarkerAlt />,
        title: "Address",
        description: "Chirakkal 670011, Kannur, Kerala, India ",
    },
];
                        ...
                        <Select name="service">
                            ...
                            <SelectContent>
                                <SelectGroup>
                                    ...
                                    <SelectItem value="est">Data Scientist</SelectItem>
                                    <SelectItem value="cst">Salesforce Developer</SelectItem>
                                    <SelectItem value="mst">Data Analyst</SelectItem>
                                </SelectGroup>
                            </SelectContent>
                        </Select>
                        {/* textarea */}
